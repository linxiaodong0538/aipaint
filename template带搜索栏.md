...
​     class="m-0 flex h-[34px] min-w-0 flex-1 items-center justify-start gap-[14rpx] rounded-full bg-white/12 px-[22rpx] py-0 text-white shadow-[inset_0_0_0_1rpx_rgba(255,255,255,0.12)] active:scale-[0.98] active:bg-white/18"
...
​     <text class="iconfont icon-sousuokuangsousuo shrink-0 text-[30rpx] leading-none text-white/90" />

​     <text

​      v-if="searchKeyword"

​      class="min-w-0 flex-1 truncate text-left text-[25rpx] font-semibold leading-[34px] text-white"
...
​      class="min-w-0 flex-1 truncate text-left text-[25rpx] font-semibold leading-[34px] text-white/72"
...
​     <text class="shrink-0 rounded-full bg-white/10 px-[14rpx] py-[4rpx] text-[20rpx] font-semibold leading-[24rpx] text-white/58">
...
​    <view class="category-tabs flex gap-[12rpx] pb-[18rpx]">
...
​      class="category-tab m-0 inline-flex w-auto min-w-0 shrink-0 items-center justify-center rounded-full px-[28rpx] py-0 text-[26rpx] font-semibold leading-[64rpx] active:scale-[0.97]"

​      :class="chip.categoryName === activeChip ? 'category-tab--active' : 'category-tab--idle'"
