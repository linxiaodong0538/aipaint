...
- Use `24rpx` as the default horizontal page margin for mobile mini program pages unless a referenced design explicitly requires otherwise.
- Use `24rpx` as the default grid/card gap for mobile mini program pages unless a referenced design explicitly requires otherwise.
