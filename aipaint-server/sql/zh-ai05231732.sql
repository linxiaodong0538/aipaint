...
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI图片生成任务表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI图片通道调用日志' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_config` VALUES (117, 'AI生图-熔断失败阈值', 'ai.image.circuitBreaker.failureThreshold', '3', 'Y', 'admin', '2026-05-22 21:10:33', '', NULL, '连续失败达到该次数后临时熔断主通道');
INSERT INTO `sys_config` VALUES (118, 'AI生图-熔断冷却分钟', 'ai.image.circuitBreaker.cooldownMinutes', '10', 'Y', 'admin', '2026-05-22 21:10:33', '', NULL, '只统计冷却窗口内的连续失败');
INSERT INTO `sys_config` VALUES (119, 'AI生图-输出格式', 'ai.image.outputFormat', 'jpeg', 'Y', 'admin', '2026-05-23 01:22:30', '', NULL, '输出格式，支持 jpeg / png');
INSERT INTO `sys_config` VALUES (120, 'AI生图-JPEG压缩强度', 'ai.image.outputCompression', '90', 'Y', 'admin', '2026-05-23 01:22:30', '', NULL, 'JPEG 压缩强度，范围 0-100，仅 outputFormat=jpeg 时生效');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-05-23 11:05:59', '2026-05-15 00:09:39', 'admin', '2026-05-15 00:09:39', '', NULL, '管理员', NULL);
...
INSERT INTO `sys_user` VALUES (103, NULL, 'wx_oSfJ5V2FCF31A3DBxB2I', '奇想造梦', '00', '', '', '2', '', '$2a$10$WJobOIfAI1q6wfVK.bGdxehSdZnIC1qyd0k3b9J4.nXxkCWml5Roi', '0', '0', '192.168.124.32', '2026-05-23 17:11:46', NULL, '', '2026-05-18 22:57:15', '', NULL, NULL, 'o_SfJ5V2FCF31A3DBxB2I3rhBMoA');
