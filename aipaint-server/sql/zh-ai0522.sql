...
INSERT INTO `ai_template` VALUES (3, 1, '孤寂雪原', '极简自然景观', 'https://lh3.googleusercontent.com/aida-public/AB6AXuC-9Tqzn7ZcHRvuGnjFaB3GnIBcWMOm0fn-qWTnBR3BAUAp6McsCn7asVqoYbbE-joxK64KiFVQccmXVRnzSY0sGxOpDu6hHjzrxmdo-wcKQkZu2esDg80MEAbyOUXo3wMbzI6sdwVnbRtgXkR6KHsxCHlO-FtxK5kIxU9tWmQUSh1XBTZ1ZmO5Vb27SAYcxvNe874iFiMBreUTW0nmTwoJo8YyCtJqWRPJhAfNKcdmnn_hHdwXT8NmZEOTZt-Po2auaCMKvhrf3P9p', 'A lonely minimal snowfield landscape, soft horizon, quiet atmosphere, pale winter light, sparse composition, cinematic stillness, fine detail, natural realism.', 'V2.4 模型', '16:9', 3, '0', 'admin', '2026-05-19 01:20:05', '', NULL, NULL);
INSERT INTO `ai_template` VALUES (4, 3, '未来结构', '3D 超现实主义', 'https://lh3.googleusercontent.com/aida-public/AB6AXuDg1wfvmjr27Z35iMy0xuxdbO88ziI23TJdPT0cf-4dN0__IH1OurtM4pHdBJbYSeACOYz_YzyVxKCFixJIbhkbHkUntzOzu_dglucTVxnTideDIwlzDCRqptOf9iAIWhQ2mJ2DkEjIc53u_3j7CREdvyLtnfzgm5u9F7UBS_QEK_6dPIULaOBMeG53jLzNU2B-SvWUniKhxBrB2b1_eQuYpRIA75Sx2BC0enE66CXtergZNJwS0BIWhczTRqOoCpCexFlPywMIkKN', 'Futuristic surreal 3D structure, impossible architectural forms, polished surfaces, dramatic studio lighting, abstract spatial depth, high-end concept art.', 'V2.4 模型', '4:3', 4, '0', 'admin', '2026-05-19 01:20:05', '', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 115 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '参数配置表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_config` VALUES (100, 'AI生图-当前生效通道', 'ai.image.activeProvider', 'primary', 'Y', 'admin', '2026-05-21 23:11:15', 'admin', '2026-05-22 01:47:04', 'primary=主通道，backup=备用通道');
INSERT INTO `sys_config` VALUES (101, 'AI生图-强制尺寸开关', 'ai.image.forceSizeEnabled', 'false', 'Y', 'admin', '2026-05-21 23:11:15', 'admin', '2026-05-22 01:47:04', 'true 开启固定尺寸，false 按比例自动推导');
INSERT INTO `sys_config` VALUES (102, 'AI生图-强制尺寸', 'ai.image.forceSize', '1024x1024', 'Y', 'admin', '2026-05-21 23:11:15', 'admin', '2026-05-22 01:47:04', '可选值：1024x1024、1536x1024、1024x1536');
INSERT INTO `sys_config` VALUES (103, 'AI生图-GPT2IMAGE主通道-名称', 'ai.image.primary.name', 'GPT2IMAGE主通道', 'Y', 'admin', '2026-05-21 23:11:15', 'admin', '2026-05-22 01:47:04', '通道展示名称');
INSERT INTO `sys_config` VALUES (104, 'AI生图-GPT2IMAGE主通道-启用', 'ai.image.primary.enabled', 'true', 'Y', 'admin', '2026-05-21 23:11:15', 'admin', '2026-05-22 01:47:04', 'true 启用，false 停用');
INSERT INTO `sys_config` VALUES (105, 'AI生图-GPT2IMAGE主通道-类型', 'ai.image.primary.type', 'openai-compatible', 'Y', 'admin', '2026-05-21 23:11:15', 'admin', '2026-05-22 01:47:04', '当前支持 openai-compatible');
INSERT INTO `sys_config` VALUES (106, 'AI生图-GPT2IMAGE主通道-BaseURL', 'ai.image.primary.baseUrl', 'https://gpt2image.superapi.buzz/v1', 'Y', 'admin', '2026-05-21 23:11:15', 'admin', '2026-05-22 01:47:04', '图片生成接口基础地址');
INSERT INTO `sys_config` VALUES (107, 'AI生图-GPT2IMAGE主通道-APIKey', 'ai.image.primary.apiKey', 'g2i_nbY7_WUJ-cgx0UZkc93X-HHuQuWV7vuQ17P_0ykXc08', 'Y', 'admin', '2026-05-21 23:11:15', 'admin', '2026-05-22 01:47:04', '图片生成接口密钥');
INSERT INTO `sys_config` VALUES (108, 'AI生图-GPT2IMAGE主通道-模型', 'ai.image.primary.model', 'gpt-image-2', 'Y', 'admin', '2026-05-21 23:11:15', 'admin', '2026-05-22 01:47:04', '例如 gpt-image-2');
INSERT INTO `sys_config` VALUES (109, 'AI生图-备用通道-名称', 'ai.image.backup.name', '备用通道', 'Y', 'admin', '2026-05-21 23:11:15', 'admin', '2026-05-22 01:47:04', '通道展示名称');
INSERT INTO `sys_config` VALUES (110, 'AI生图-备用通道-启用', 'ai.image.backup.enabled', 'true', 'Y', 'admin', '2026-05-21 23:11:15', 'admin', '2026-05-22 01:47:04', 'true 启用，false 停用');
INSERT INTO `sys_config` VALUES (111, 'AI生图-备用通道-类型', 'ai.image.backup.type', 'openai-compatible', 'Y', 'admin', '2026-05-21 23:11:15', 'admin', '2026-05-22 01:47:04', '当前支持 openai-compatible');
INSERT INTO `sys_config` VALUES (112, 'AI生图-备用通道-BaseURL', 'ai.image.backup.baseUrl', 'https://dm-fox.rjj.cc/codex/v1', 'Y', 'admin', '2026-05-21 23:11:15', 'admin', '2026-05-22 01:47:04', '图片生成接口基础地址');
INSERT INTO `sys_config` VALUES (113, 'AI生图-备用通道-APIKey', 'ai.image.backup.apiKey', 'sk-ant-oat01-TreuJkePrRVBLbNv3yhT6jldXpYQWhHBsuwfIGpodeVIbS1iOqBbRlTHTTRExLko8fiuTDw9EucS-PvtU2yemsMx38NKDAA', 'Y', 'admin', '2026-05-21 23:11:15', 'admin', '2026-05-22 01:47:04', '图片生成接口密钥');
INSERT INTO `sys_config` VALUES (114, 'AI生图-备用通道-模型', 'ai.image.backup.model', 'gpt-image-2', 'Y', 'admin', '2026-05-21 23:11:15', 'admin', '2026-05-22 01:47:04', '例如 gpt-image-2');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-05-22 01:19:42', '2026-05-15 00:09:39', 'admin', '2026-05-15 00:09:39', '', NULL, '管理员', NULL);
...
INSERT INTO `sys_user` VALUES (103, NULL, 'wx_oSfJ5V2FCF31A3DBxB2I', '奇想造梦', '00', '', '', '2', '', '$2a$10$WJobOIfAI1q6wfVK.bGdxehSdZnIC1qyd0k3b9J4.nXxkCWml5Roi', '0', '0', '192.168.31.112', '2026-05-22 02:14:04', NULL, '', '2026-05-18 22:57:15', '', NULL, NULL, 'o_SfJ5V2FCF31A3DBxB2I3rhBMoA');
