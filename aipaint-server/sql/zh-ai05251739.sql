...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户积分批次表' ROW_FORMAT = Dynamic;
...
INSERT INTO `ai_credit_batch` VALUES (2, 103, 'NEW_USER_GIFT', '103', 100, 60, '2026-06-01 15:49:59', '新人礼包，7天有效', '2026-05-25 15:49:59', '2026-05-25 17:17:06');
INSERT INTO `ai_credit_batch` VALUES (3, 103, 'GENERATION_REFUND', '38', 5, 5, '2026-06-01 15:50:19', '生成失败退款，7天有效', '2026-05-25 15:50:19', NULL);
INSERT INTO `ai_credit_batch` VALUES (4, 103, 'GENERATION_REFUND', '40', 5, 5, '2026-06-01 16:09:24', '生成失败退款，7天有效', '2026-05-25 16:09:24', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户积分流水表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 46 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI图片生成任务表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `ai_image_model_route` VALUES ('gpt-image-2', 1, 'grsai', 'superapi', 1, 1, 'GPT 主用 SuperAPI，失败切 Grsai', '2026-05-25 17:08:55', '2026-05-25 17:08:55');
INSERT INTO `ai_image_model_route` VALUES ('nano-banana-2', 1, 'grsai', NULL, 0, 2, 'nano-banana 固定走 Grsai', '2026-05-25 17:08:55', '2026-05-25 17:08:55');
...
-- ----------------------------
INSERT INTO `ai_image_provider` VALUES ('grsai', 'Grsai 中转站', 'grsai-async', 'json', 'https://grsai.dakka.com.cn', 'sk-8bf47400c7774296a2b52b9f24623d95', 1, 2, '支持 GPT 与 nano-banana 的中转站', '2026-05-25 17:08:55', '2026-05-25 17:08:55');
INSERT INTO `ai_image_provider` VALUES ('superapi', 'SuperAPI 中转站', 'openai-compatible', 'stream', 'https://gpt2image.superapi.buzz/v1', 'g2i_nbY7_WUJ-cgx0UZkc93X-HHuQuWV7vuQ17P_0ykXc08', 1, 1, '默认 GPT 主通道', '2026-05-25 17:08:55', '2026-05-25 17:08:55');
...
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI图片通道调用日志' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `ai_image_provider_model` VALUES ('grsai', 'gpt-image-2', 1, '2026-05-25 17:08:55', '2026-05-25 17:08:55');
INSERT INTO `ai_image_provider_model` VALUES ('grsai', 'gpt-image-2-vip', 1, '2026-05-25 17:08:55', '2026-05-25 17:08:55');
INSERT INTO `ai_image_provider_model` VALUES ('grsai', 'nano-banana-2', 1, '2026-05-25 17:08:55', '2026-05-25 17:08:55');
INSERT INTO `ai_image_provider_model` VALUES ('grsai', 'nano-banana-pro', 1, '2026-05-25 17:08:55', '2026-05-25 17:08:55');
INSERT INTO `ai_image_provider_model` VALUES ('superapi', 'gpt-image-2', 1, '2026-05-25 17:08:55', '2026-05-25 17:08:55');
...
INSERT INTO `sys_config` VALUES (117, 'AI生图-熔断失败阈值', 'ai.image.circuitBreaker.failureThreshold', '3', 'Y', 'admin', '2026-05-22 21:10:33', 'admin', '2026-05-25 17:08:55', '连续失败达到该次数后临时熔断主通道');
INSERT INTO `sys_config` VALUES (118, 'AI生图-熔断冷却分钟', 'ai.image.circuitBreaker.cooldownMinutes', '10', 'Y', 'admin', '2026-05-22 21:10:33', 'admin', '2026-05-25 17:08:55', '只统计冷却窗口内的连续失败');
INSERT INTO `sys_config` VALUES (119, 'AI生图-输出格式', 'ai.image.outputFormat', 'jpeg', 'Y', 'admin', '2026-05-23 01:22:30', 'admin', '2026-05-25 17:08:55', '支持 jpeg、png');
INSERT INTO `sys_config` VALUES (120, 'AI生图-JPEG压缩强度', 'ai.image.outputCompression', '90', 'Y', 'admin', '2026-05-23 01:22:30', 'admin', '2026-05-25 17:08:55', '范围 0-100，仅对 jpeg 有效');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-05-25 15:43:57', '2026-05-15 00:09:39', 'admin', '2026-05-15 00:09:39', '', NULL, '管理员', NULL);
...
INSERT INTO `sys_user` VALUES (103, NULL, 'wx_oSfJ5V2FCF31A3DBxB2I', '奇想造梦', '00', '', '', '2', '', '$2a$10$WJobOIfAI1q6wfVK.bGdxehSdZnIC1qyd0k3b9J4.nXxkCWml5Roi', '0', '0', '192.168.124.41', '2026-05-25 17:10:40', NULL, '', '2026-05-18 22:57:15', '', NULL, NULL, 'o_SfJ5V2FCF31A3DBxB2I3rhBMoA');
