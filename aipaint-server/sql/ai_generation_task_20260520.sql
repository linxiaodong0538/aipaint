create table if not exists ai_generation_task (
  ...
  resolution       varchar(16)     not null default '2k'      comment '分辨率档位',
  image_urls       text            default null               comment '参考图URL，逗号分隔',
  image_count      int(11)         not null default 1         comment '生成张数',
  status           varchar(32)     not null                   comment '任务状态',
  progress         int(11)         not null default 0         comment '任务进度',
