...
) ENGINE = InnoDB AUTO_INCREMENT = 47 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户积分批次表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `ai_credit_batch` VALUES (9, 103, 'MANUAL_TEST', 'manual_test_20260526191754', 1000, 541, NULL, '测试手动加积分', '2026-05-26 19:17:54', '2026-05-30 15:03:57');
...
INSERT INTO `ai_credit_batch` VALUES (40, 103, 'SIGNIN', '2026-05-30', 10, 5, '2026-06-06 18:10:38', '每日签到奖励，7天有效', '2026-05-30 18:10:38', '2026-05-31 23:46:52');
INSERT INTO `ai_credit_batch` VALUES (41, 103, 'SIGNIN', '2026-05-31', 10, 10, '2026-06-07 10:31:11', '每日签到奖励，7天有效', '2026-05-31 10:31:11', NULL);
...
INSERT INTO `ai_credit_batch` VALUES (46, 103, 'SIGNIN', '2026-06-01', 10, 10, '2026-06-08 01:00:51', '每日签到奖励，7天有效', '2026-06-01 01:00:51', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 139 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户积分流水表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 129 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI图片生成任务表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `ai_generation_task` VALUES (112, 103, 'grsai', '一只粉红色的小猪佩奇，圆圆的吹风机式鼻子，两只黑色大眼睛带着调皮微笑，身穿红色连衣裙，脚踩黑色小皮鞋，站立在阳光明媚的草地上，身后是佩奇家的红色屋顶房子和绿色树木。明亮自然光，柔和高光，画面色彩鲜艳饱和，卡通动画风格，角色边缘光滑，质感细腻如塑料玩具，半身构图，视线平视，背景虚化突出主体。', 'gpt-image-2', 'auto', '1:1', '1024x1024', '1K', '', 1, 'processing', 10, NULL, NULL, NULL, 6, '2026-05-30 14:19:07', NULL, 'wx_oSfJ5V2FCF31A3DBxB2I', '2026-05-30 14:19:07', '', '2026-05-30 14:19:07');
...
) ENGINE = InnoDB AUTO_INCREMENT = 110 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI图片通道调用日志' ROW_FORMAT = DYNAMIC;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2026-05-30 15:06:37', '2026-05-15 00:09:39', 'admin', '2026-05-15 00:09:39', '', NULL, '管理员', NULL);
...
INSERT INTO `sys_user` VALUES (103, NULL, 'wx_oSfJ5V2FCF31A3DBxB2I', '奇想造梦', '00', '', '', '2', '', '$2a$10$WJobOIfAI1q6wfVK.bGdxehSdZnIC1qyd0k3b9J4.nXxkCWml5Roi', '0', '0', '192.168.31.112', '2026-06-01 00:59:25', NULL, '', '2026-05-18 22:57:15', '', NULL, NULL, 'o_SfJ5V2FCF31A3DBxB2I3rhBMoA');
